...
type ResponseQueryRangeResult struct {
	Metric *QueryDataResultMetric `json:"metric,omitempty"`
	Values []OneOfresponseQueryRangeResultValuesItems `json:"values,omitempty"`
}
