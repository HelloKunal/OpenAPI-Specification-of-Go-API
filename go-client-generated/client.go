...
// APIClient manages communication with the Prometheus HTTP API API vv2
...
type APIClient struct {
	...
	ExpressionQueryApi *ExpressionQueryApiService

	QueryingMetadataApi *QueryingMetadataApiService

	StatusApi *StatusApiService

	TSDBAdminAPIApi *TSDBAdminAPIApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ExpressionQueryApi = (*ExpressionQueryApiService)(&c.common)
	c.QueryingMetadataApi = (*QueryingMetadataApiService)(&c.common)
	c.StatusApi = (*StatusApiService)(&c.common)
	c.TSDBAdminAPIApi = (*TSDBAdminAPIApiService)(&c.common)
